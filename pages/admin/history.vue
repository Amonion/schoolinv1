  ...
  <div class="admin-container">
    <div class="admin-home-flex">
      <h2 class="admin-page-title">
        History<span class="admin-page-time">{{ formatDate() }}</span>
      </h2>
...
export default {
  ...
  methods: {
    ...
    toggleSelectAllItems() {
      this.$store.commit(`admin/toggleSelectAllItems`, "history-settings");
    },
    ...
    async getHistory() {
      await this.$store.dispatch(
        "admin/getHistory",
        `/transactions/?limit=${this.limit}&page=${this.currentPage}&sort=${this.sort}&status=1`
      );
    },
  },
  ...
  computed: {
    ...
    totalLength() {
      return this.$store.state.admin.historyLength;
    },

    selectedItems() {
      return this.$store.state.admin.selectedHistory;
    },

    isAllItemsSelected() {
      return this.$store.state.admin.isAllHistorySelected;
    },

    history() {
      return this.$store.state.admin.history;
    },
  },
};
</script>
